...
import { assert, createArray } from 'utils';
import { toInt32, toUnsignedInt32 } from 'memory/coercion';
...
export function createMemoryState(): mstate {
  return {
    smallmap: 0,
    treemap: 0,
    dvsize: 0,
...
interface mallocState {         // struct malloc_state {
 ...
 export type mstate = mallocState; //typedef struct malloc_state*    mstate;
